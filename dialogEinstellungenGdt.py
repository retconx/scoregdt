...
class EinstellungenGdt(QDialog):
    def __init__(self, configPath):
        ...
        self.idScoreGdt = configIni["GDT"]["idscoregdt"]
        self.idPraxisEdv = configIni["GDT"]["idpraxisedv"]
        self.kuerzelScoreGdt = configIni["GDT"]["kuerzelscoregdt"]
        ...
        labelScoreGdt = QLabel("ScoreGDT:")
        labelScoreGdt.setStyleSheet("font-weight:normal")
        ...
        self.lineEditScoreGdtId = QLineEdit(self.idScoreGdt)
        self.lineEditScoreGdtId.setStyleSheet("font-weight:normal")
        self.lineEditScoreGdtId.setEnabled(False)
        self.lineEditPraxisEdvId = QLineEdit(self.idPraxisEdv)
        self.lineEditPraxisEdvId.setStyleSheet("font-weight:normal")
        groupboxLayoutG.addWidget(labelScoreGdt, 0, 0)
        groupboxLayoutG.addWidget(self.lineEditScoreGdtId, 0, 1)
        ...
        labelScoreGdtKuerzel = QLabel("ScoreGDT:")
        labelScoreGdtKuerzel.setStyleSheet("font-weight:normal")
        labelPraxisEdvKuerzel = QLabel("Praxis-EDV:")
        labelPraxisEdvKuerzel.setStyleSheet("font-weight:normal")
        self.lineEditScoreGdtKuerzel = QLineEdit(self.kuerzelScoreGdt)
        self.lineEditScoreGdtKuerzel.textChanged.connect(self.kuerzelGeaendert) # type:ignore
        self.lineEditScoreGdtKuerzel.setStyleSheet("font-weight:normal")
        self.lineEditScoreGdtKuerzel.setEnabled(False)
        ...
        self.labelImportDateiname = QLabel("Import-Dateiname: " + self.lineEditScoreGdtKuerzel.text() + self.lineEditPraxisEdvKuerzel.text() + ".gdt")
        self.labelImportDateiname.setStyleSheet("font-weight:normal")
        self.labelExportDateiname = QLabel("Export-Dateiname: " + self.lineEditPraxisEdvKuerzel.text() + self.lineEditScoreGdtKuerzel.text() + ".gdt")
        self.labelExportDateiname.setStyleSheet("font-weight:normal")
        groupboxLayoutG.addWidget(labelScoreGdtKuerzel, 0, 0)
        groupboxLayoutG.addWidget(self.lineEditScoreGdtKuerzel, 0, 1)
        ...
        self.lineEditScoreGdtId.setFocus()
        self.lineEditScoreGdtId.selectAll()

    def kuerzelGeaendert(self):
        kuerzelScoreGdt = self.lineEditScoreGdtKuerzel.text()
        kuerzelPraxisEdv = self.lineEditPraxisEdvKuerzel.text()
        self.labelImportDateiname.setText("Import-Dateiname: " + kuerzelScoreGdt + kuerzelPraxisEdv + ".gdt")
        self.labelExportDateiname.setText("Export-Dateiname: " + kuerzelPraxisEdv + kuerzelScoreGdt + ".gdt")
